// src/components/layout/GameCard.tsx — full replace
  ...
  return (
    ...
    >
      <div className="flex h-40 items-center justify-center bg-[#181611]">
        <span className="font-serif text-5xl text-[#705c3b]">♟</span>
      </div>
      ...
      <div className="p-4">
        ...
        <p className="mt-1 text-xs text-[#786d5b]">{game.event}</p>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <span className="text-sm text-[#c08b3c]">★ {game.rating}</span>
        </div>
